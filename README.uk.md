...
Досвід танка на дослідження, срібло на купівлю, досвід
екіпажу, який тихо покращує все. Стоїш у кінці гілки —
досвід стає **вільним** і йде на будь-яке дослідження,
тож тупиків нема. Усі модулі 5/5 → танк стає **ЕЛІТНИМ**.
...
### 🛡 Три типи раунду
**Зачистка** — вибий усіх. **Штурм** — прорвися до ☭ штабу:
він за сталевим щитом, доки не виб'єш половину загону, а далі
сталеві борти й два ДОТи. **Оборона** — витримай п'ять хвиль,
кожна більша за попередню, і 85% з них їдуть саме на твою ★.

</td><td>

### ⚔ Складність бачить твою збірку
Вороги масштабуються від того, наскільки танк реально сильний,
а не від номера тіру — тож прокачаний танк зустрічає прокачаних
ворогів, а не стає невразливим. А ★ працює як в оригінальному
Battle City: швидший снаряд, далі урон, далі другий ствол.

</td></tr>
<tr><td>

### 🤝 Союзник з першої секунди
Союзний СТ виїжджає разом з тобою — 75% твоїх HP, 80% урону —
і збирає коробки та зірки, віддаючи їх **тобі**.
Рідкісна коробка приводить другого.

</td><td>

### 🎼 Шість саундтреків без аудіофайлів
Музика читає раунд. 8-біт поки б'єшся, мінор і швидше на хвилі,
хроматична тривога під 32% міцності, мажор на прориві, орган
в ангарі й на босі. Усе синтезується на льоту, трек міняється
на межі такту.
...
### Ангар, який усе пам'ятає — і влазить в один екран

<img src="docs/hangar.png" width="760" alt="Ангар: усе дерево як чотири рядки гілок, характеристики, модулі, вкладки">
...
├── CHANGELOG.md    що змінилось у кожній версії, з цифрами
└── docs/           скріншоти
```

Що і коли змінювалось: **[CHANGELOG.md](CHANGELOG.md)**.
