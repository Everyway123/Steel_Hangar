...
## 🏁 Друга гра в репо: ПІТВОЛ 2026

У папці [`pitwall/`](pitwall/) живе окремий проєкт — F1-менеджер із сезоном 2026,
регулятором довжини гонки (25 / 50 / 100% дистанції) і broadcast-виглядом як у F1 TV.
Vite + TypeScript, симуляція відокремлена від рендеру й покрита тестами.

Зараз там готовий движок гонки (M1): `cd pitwall && npm install && npm run race`.
Деталі моделі й калібрування — у [pitwall/README.md](pitwall/README.md).
